...
function Dashboard() {
    ...
    const fetchDashboardData = async () => {
        const stats_res = await apiInstance.get(`Dashboard/stats/${userId}/`);
        setStats(stats_res.data[0]);

        const post_res = await apiInstance.get(`Dashboard/post-list/${userId}/`);
        setPosts(post_res.data);
        console.log(post_res?.data)

        const comment_res = await apiInstance.get(`DashboardCommentList/${userId}/`);
                                                ...
                                                <div className="col-12">
                                                    <div className="d-flex align-items-center position-relative">
                                                        <div className="avatar avatar-lg flex-shrink-0">
                                                            <img className="avatar-img" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.shutterstock.com%2Fsearch%2Fdefault-user&psig=AOvVaw3zgEMaRr5ycvIehWdSrTO3&ust=1739162664171000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCIiO7P3jtYsDFQAAAAAdAAAAABAE" style={{ width: "100px", height: "100px", objectFit: "cover", borderRadius: "50%" }} alt="avatar" />
                                                        </div>
                                                        <div className="ms-3">
                                                            <p className="mb-1">
